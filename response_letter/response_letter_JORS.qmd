...
\textcolor{teal}Large-scale empirical research on further exploring which strategy may work best in different scenarios also provide useful insights.}
...
**Response:** Thank you for your feedback. We have provide a detailed explanation of each figure in the manuscript, as well as in the captions of each figure, discussing them one by one to ensure clarity.
