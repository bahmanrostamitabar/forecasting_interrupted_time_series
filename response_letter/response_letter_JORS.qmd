...
**Response:** Thank you very much for giving us an opportunity to revise the manuscript. The valuable feedback provided by the referees. We have thoroughly reviewed their comments and made any required changes. We have highlighted all changes with coloured text in both the response letter and the manuscript. 
...
Response: Thank you for your feedback. We appreciate your comments on the writing quality and your recommendations for improving the paper's contributions. We believe that the originality of our research comes from addressing the actual challenges that many forecasters and modellers experience when their time series data is disturbed by recommending multiple viable and reliable strategies suitable for different cases. However, we recognise that presenting a new technique may be an exciting direction, and we have included it as a potential topic for future research in this area. Also, we included two empirical datasets from two different application areas in the paper. Moreover, the whole paper is reproducible, and the datasets and R codes are accessible on GitHub, allowing strategies to be tailored to any dataset in any application.

\textcolor{teal}{This study proposes multiple viable and reliable strategies for forecasting time series data interrupted by different type of events. Future research could focus on developing a new strategy specifically for such disrupted time series, using large-scale data from various applications that are interrupted by different events, and analysing which strategy may work best in which scenarios.}
...
**Response:** Thank you for taking the time to review our article. We appreciate your feedback and your acknowledgment of the interesting aspects of our work. Your comments are valuable to us and will help improve the quality of our work. We understand your concern about the empirical design, and we will discuss this in our response to your specific comments below.
...
**Response:** Thank you for your helpful comment. We agree that the patterns of interrupted events may vary, which would affect the suitability of proposed approaches. That is why we have proposed different strategies to consider that might be appropriate in different cases, each with its own pros and cons.  In future work, a large scale empirical study covering several types of disruption could be conducted to provide deeper insights and any possible link between strategies and types of disruption events. We have included the following paragraph in the conclusion section of the revised manuscript:

\textcolor{teal}{This study proposes multiple viable and reliable strategies for forecasting time series data interrupted by different type of events. Future research could focus on developing a new strategy specifically for such disrupted time series, using large-scale data from various applications that are interrupted by different events, and analysing which strategy may work best in which scenarios.}

_Comment 3. The authors provide some visualizations on the forecasting. This should be appreciated since it is quite straightforward. However, the authors may not expect the readers to judge the optimal strategy from these figures. Instead, the authors should consider some out-of-sample validation and may introduce some metrics or measures to evaluate the performance different strategies._ Rob
...
**Response:** Thank you for your suggestion. We completely agree that incorporating exogenous variables related to specific events could enhance the performance of forecasting models for interrupted time series. We have acknowledged this by adding the following paragraph to the revised manuscript:
...
_Comment 1: Different strategies are discussed in section 2 in a few words without giving a proper introduction of the strategies. It makes the reading of the manuscript difficult. The authors are required to give practical examples of the strategies to make it understandable to read._ Rob


_Comment 2. No mathematical support is provided as to how the strategies work. And what are the practical implementation of the strategies? Authors are required to provide detailed insight into the strategies i.e. which datasets these strategies are applied?_ Rob
...
_Comment 4. Two datasets are used and the strategies are applied to them. However, the descriptive statistics of these data sets missing.. The authors are required to explain the datasets._ Rob
...
**Response:** Thank you for your comment. We have made sure to include relevant literature in our paper. We would like to clarify that our study does not focus on forecasting COVID-19-related data and variables, such as COVID19 patient count, or statistical data, as suggested. Instead, our paper addresses interrupted time series data caused by events like pandemics, strikes, and other disruptions. We have included literature relevant to this topic. Your feedback is appreciated, and we hope this clarifies the scope and focus of our research.
