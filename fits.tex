...
variables are chosen well.
\textcolor{teal}{Intervention models are useful because they enable the forecasting of similar future disruptions, but distinguishing between a disruption and a general driving factor, such as a promotion or a seasonal storm, may become subjective.}
However, the model will assume that the post-interruption period will be
similar to the pre-interruption period, and so the prediction intervals
may be too narrow, especially if there is a lasting effect beyond the
