...
fit ARIMA and dynamic ARIMA models to the data, with no transformations
used. We have evaluated the methods by using time series
...
end of 2021. The test sets are always 1 week long. Thus, we have
...
Figures \ref{fig-walkers-plot1}--\ref{fig-walkers-plot4}
...
into account the lockdown periods, but the ARIMA model is able to adjust
to the changing level of the series.}
...
\includegraphics{fits_files/figure-pdf/unnamed-chunk-14-1.pdf}
