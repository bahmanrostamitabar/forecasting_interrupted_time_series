...
#| fig-height: 8
#| fig-caption: Solution 1. ETS is highly adaptive.
tar_read(tsol1_plot)
```
...
#| fig-height: 8
#| fig-caption: Solution 2. We use a left shift in March 2020, and a ramp from November 2022.
tar_read(tsol2_plot)
```
...
#| fig-height: 8
#| fig-caption: Solution 3. The period from March 2020 to November 2022 is set to missing.
tar_read(tsol3_plot)
```
...
#| fig-height: 8
#| fig-caption: Solution 4. The period from March 2020 to November 2022 is set to missing.
tar_read(tsol4_plot)
```
