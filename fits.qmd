...
In the context of forecasting disruptions such as the COVID-19 pandemic, Bayesian approaches have been proposed for detecting changing points in outbreaks and forecasting case numbers under counterfactual scenarios [@dehning2020inferring]. Counterfactual analysis examines what would have happened to the forecast variable of interest if the disruptive event had not occurred. @athanasopoulos2023probabilistic proposed a variant of this approach for forecasting tourism recovery from COVID-19, combining forecast reconciliation and forecast combinations applied to historical data, to generate COVID-free counterfactual forecasts of what might have been if the pandemic never occurred. Then scenario-based judgemental probabilistic forecasts were compared with the counterfactual forecasts, to better understand the future recovery of the tourism sector from the pandemic.
