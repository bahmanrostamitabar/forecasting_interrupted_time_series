...
We will apply each of the approaches above to this data set, and compare their performance.
...
#| fig-height: 8
#| fig-cap: Solution 2. We use a left shift in March 2020, and a ramp from November 2022 to June 2023.
tar_read(tsol2_plot)
```
...
#| fig-height: 8
#| fig-cap: Solution 3. The period from March 2020 to November 2022 is set to missing. So the first three years of forecasts show what might have been. The fourth set of forecasts uses observations from November and December 2022, and so the forecasts have been adjusted downwards.
tar_read(tsol3_plot)
```
...
#| fig-height: 8
#| fig-cap: Solution 4. We replace the observations from March 2020 to November 2022 with the average of the same month in the 3 preceding years. 
tar_read(tsol4_plot)
```
